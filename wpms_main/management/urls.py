...
urlpatterns = [
    ...
    path('acceptanceact/<int:id>/secondmaterial', views.acceptanceactsecondmaterial, name='acceptanceactsecondmaterial'),
    path('acceptanceact/<int:id>/skip', views.acceptance_act_skip_second_material, name='acceptance_act_skip_second_material'),
    ...
    path('penalspecification/<int:id>/init', views.penal_specification_init, name='penal_specification_init'),
    path('penalspecification/<int:id>/weight', views.penal_specification_weight, name='penal_specification_weight'),
    path('penalspecification/<int:id>/count', views.penal_specification_count, name='penal_specification_count'),
    path('penalspecification/<int:id>/carweight', views.penal_specification_carweight, name='penal_specification_carweight'),
